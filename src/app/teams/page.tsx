...
export default function TeamsPage() {
  ...
  const { teams, myTeam, loading, fetchTeams, fetchMyTeam, createTeam, joinTeam } = useTeamStore();
      ...
      <div className="max-w-[1100px] mx-auto px-6 py-16">
        <div className="animate-fade-in">
          ...
          <p className="text-text-muted text-lg mb-10">
            Create or join a team to participate in the jam.
          </p>
        </div>
            ...
            {!user ? (
              <div className="glass-strong rounded-xl p-6">
                <div className="flex items-center gap-3 mb-4">
                  <span className="material-symbols-rounded text-2xl text-warning">
                    lock
                  </span>
                ...
                <p className="text-text-muted mb-4">
                  You need to be logged in to create or join a team.
                </p>
              ...
              <div className="glass-strong rounded-xl p-6">
                <div className="flex items-center gap-3 mb-4">
                  <span className="material-symbols-rounded text-2xl text-success">
                    check_circle
                  </span>
                  <h2 className="text-lg font-semibold text-text-bright">
                    Your Team
                ...
                <p className="text-text-bright font-semibold text-lg mb-1">
                  {myTeam.name}
                </p>
          ...
          <div className="animate-fade-in">
            ...
            {loading ? (
              <div className="glass rounded-xl p-8 text-center">
                <span className="material-symbols-rounded text-3xl text-primary animate-spin">
                  progress_activity
                </span>
              ...
              <div className="glass rounded-xl p-8 text-center">
                <span className="material-symbols-rounded text-3xl text-text-muted">
                  group_off
                </span>
                    ...
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          <h3 className="text-text-bright font-semibold truncate">
                            {team.name}
                          </h3>
                        </div>
                        {team.description && (
                      ...
                      <div className="flex items-center gap-1.5 shrink-0">
                        <span className="material-symbols-rounded text-base text-text-muted">
                          person
                        </span>
